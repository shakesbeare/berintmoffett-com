...
export function wasm_bindgen__convert__closures__invoke1_mut__h12b2db23179a8d83(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h492a29c8e0c50bbd(a: number, b: number, c: number, d: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h1c2ef7e32386b283(a: number, b: number): void;
